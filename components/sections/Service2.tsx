							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> Servicios </span>
									</div>
									<h3>
										Diseño de soluciones personalizadas <br /> para satisfacer sus necesidades
									</h3>
								</div>
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desarrollo Web &amp; App</h6>
												<p className="fs-7 text-300 fw-regular">Creación de interfaces visualmente atractivas y fáciles de usar utilizando <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, y marcos modernos como React y Nextjs</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Gestión de Bases de Datos</h6>
												<p className="fs-7 text-300 fw-regular">Diseño y gestión de bases de datos con tecnologías <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">PostgreSQL</span>, y <span className="text-secondary-2">MongoDB</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desarrollo API</h6>
												<p className="fs-7 text-300 fw-regular">Creación e integración de <span className="text-secondary-2">RESTful APIs</span> para permitir una comunicación fluida entre los sistemas front-end y back-end.
												</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Optimización</h6>
												<p className="fs-7 text-300 fw-regular">Mejorar la velocidad y el rendimiento de las aplicaciones web para ofrecer una mejor experiencia de usuario. Trabajar con <span className="text-secondary-2">Nodejs</span>, <span className="text-secondary-2">Express</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">E-commerce</h6>
												<p className="fs-7 text-300 fw-regular">Desarrollar soluciones de pago escalables y seguras con plataformas de <span className="text-secondary-2">e-commerce</span> adaptado a las necesidades de su negocio.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Integración de IA</h6>
												<p className="fs-7 text-300 fw-regular">Impulse sus aplicaciones con IA para lograr una mayor eficiencia, automatización y una mejor experiencia de usuario.</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											Me entusiasma emprender <span className="text-dark">nuevos proyectos</span> y colaborar. <br />
											Hablemos sobre tus ideas. <Link href="#" className="text-primary-2">Conversemos</Link>
										</p>
									</div>
								</div>
							</div>
							<img className="position-absolute top-0 start-0 z-0" src="assets/imgs/home-page-2/services/bg.png" alt="toledo" />
						</div>
					</div>
				</div>
			</section>
