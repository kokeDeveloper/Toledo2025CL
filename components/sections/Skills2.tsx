							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center">Tecnologías </span>
									</div>
									<h3>Stack</h3>
								</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															...
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	...
																	<span className="text-300">Node.js, Express, Python, ASP.NET</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Bases de datos:</p>
																	<span className="text-300">MySQL, PostgreSQL, MongoDB</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Herramientas &amp; Plataformas:</p>
																	<span className="text-300">Git, Docker, AWS</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Otros:</p>
																	<span className="text-300">RESTful APIs, App Mobile, Illustrator, Photoshop, XD, Premiere, After Effects</span>
																</div>
															</li>
														</ul>
													</div>
