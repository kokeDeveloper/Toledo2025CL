										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hola, soy Jorge</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3">Developer<span className="text-linear-4">{'{'}Full Stack{'}'}</span>&amp; Marketing Digital<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">Soy ingeniero informático especializado en el desarrollo de productos 
											digitales, con una sólida experiencia en comunicaciones. Manejo tecnologías como</span> <span className="text-secondary-2">NodeJS</span>, 
											<span className="text-secondary-2"> React</span>, <span className="text-secondary-2"> NextJs </span>
											 y
											 <span className="text-secondary-2">ASP.Net.</span><span className="text-dark"> Mi habilidad abarca todo el espectro del proceso de creación, desde el desarrollo de software hasta el diseño gráfico, lo que me permite ofrecer soluciones digitales completas y personalizadas.
											</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
											...
											<div className="col-5 d-flex align-items-end">
												<span className="fs-6 text-300 mb-2">...y más</span>
											</div>
										</div>
										<Link href="/cv_JorgeToledo_2025.pdf" className="btn me-2 text-300 ps-0 mt-4" target="_blank">
