					...
					<div className="offCanvas__side-info mb-30">
						<div className="contact-list mb-30">
							...
							<div className="mb-3">
								...
								<p className="mb-0">+569-4235-36-56</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Email</span>
								<p className="mb-0">contact@jorgetoledo.cl</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Skype</span>
								<p className="mb-0">jorge.toledo_3</p>
							</div>
							<div className="mb-3">
								<span className="text-400 fs-5">Direccion</span>
